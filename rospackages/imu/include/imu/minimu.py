...
### Python module to control several aspects of Pololu's MinIMU-10v5 ###
#
# This module enables the Raspberry PI embedded computer to set up and
# use various aspects of Pololu's MinIMU-10v5 Inertial Measurement Unit
# (IMU).
...
class MinIMU(LIS3MDL, LSM6DS33):
    """ Class to control Pololu's MinIMU-9 v5. """
